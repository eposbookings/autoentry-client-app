...
def test_credit_note_deletion_allows_posted_fully_unallocated_document():
    assert server.unallocated_credit_note_is_deletable({
        "status": "posted",
        "gross_amount": "120.00",
        "unallocated_amount": "120.00",
    }) is True


def test_credit_note_deletion_stops_after_part_allocation():
    assert server.unallocated_credit_note_is_deletable({
        "status": "part_paid",
        "gross_amount": "120.00",
        "unallocated_amount": "80.00",
    }) is False
